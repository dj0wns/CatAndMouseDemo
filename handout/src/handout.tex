...
Like with random, we have to add the following code to the top of our file so that we can access the \q{sqrt} and \q{pow} functions.
...
\item An example with the last 3 listed challenges can be found at \url{https://onlinegdb.com/BkEkWasTQ}

\item Experiment and try to add your own changes!
